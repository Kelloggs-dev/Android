...
public class List_Racing extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_list_racing);
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(List_Racing.this, MainActivity.class);
        ...
        btnDrivers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(List_Racing.this, List_Drivers.class);
                startActivity(intent);
            }
        });
        ...
        btnCompte.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(!User.getConnecter()) {
                    intent = new Intent(List_Racing.this, Compte.class);
    ...
    public void Affiche_List(){
        ...
        ListView List_Racing = (ListView)findViewById(R.id.list_racing);
        RacingAdapter adapter = new RacingAdapter(this,R.layout.list_item_racing);
                        ...
                        try {
                            ...
                            if(Results.equals("200")) {
                                ...
                                for (int count = 0; count < Data.length(); count++) {
                                    ...
                                    C_RACING uneRace = new C_RACING();
                                    uneRace.setDateRacing(Object.getString("dateRacing"));
                                    uneRace.setLieu(Object.getString("Lieu"));
        ...
        List_Racing.setAdapter(adapter);
                        ...
                        try {
                            ...
                            if(Results.equals("200")){
                                ...
                                if(User.getId_Contrat().equals("500")){
                                    Intent intent = new Intent(List_Racing.this,Compte_Admin.class);
                                    startActivity(intent);
                                }else {
                                    Intent intent = new Intent(List_Racing.this,Compte_Connecter.class);
                                    startActivity(intent);
                                }
